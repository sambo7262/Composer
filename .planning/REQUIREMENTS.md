...
- [x] **SUGG-04**: Refill pipeline: audio-feature distance to taste-profile centroid + top-K vibe centroids → shortlist of ~50 unrated candidates → Anthropic LLM ranks the shortlist → top N picks are added to fill the queue back to target
